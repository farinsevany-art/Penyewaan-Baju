        ...
        onSubmitted: (value) {
          if (value.isNotEmpty) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => OrdersPage(orderId: value),
              ),
            );
          }
        },
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          right: 15,
          top: 0,
          child: _catItem(context, 'Pewayangan', 'assets/images/wayang.jpg', 4),
        ),
      ],
    );
  }
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => CategoryDetailPage(
              categoryTitle:
                  categoryToSend, // Mengirimkan judul yang sudah dibersihkan
            ),
          ),
        );
      },
